# pydantic turn data into json format
import os
...
# structure it
from pydantic import BaseModel# to get in json formate with schema
...
# f """""" help to convert into string(formatted string literal)
system_prompt=f"""
